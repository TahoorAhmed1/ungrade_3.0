...
import { CompetencyDialog } from "@/components/admin/dialogs/competency";
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-between mb-2">
        <h1 className="font-semibold text-2xl ">Manage Competency</h1>
        <Button
          onClick={() => {
            setdata({})
            setType("add");
        ...
        >
          <Plus className="w-5 h-5 mr-2" /> Add Competency
        </Button>
      </div>
