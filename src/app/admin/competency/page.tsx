...
import AdminCompetency from '@/components/admin/competency/competency';
...
async function fetchCompetency() {
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_DEPLOY_BASE_V2_URL}api/admin/competency`,
      {
        method: 'GET',
...
export default async function Page() {
  ...
  return <AdminCompetency DataTable={DataTable} data={competency} />;
}