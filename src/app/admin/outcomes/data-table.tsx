...
import { OutcomesDialog } from "@/components/admin/dialogs/outcomes";
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-between mb-2">
        <h1 className="font-semibold text-2xl ">Manage Outcome</h1>
        <Button
          onClick={() => {
            setdata({})
            setType("add");
        ...
        >
          <Plus className="w-5 h-5 mr-2" /> Add Outcome
        </Button>
      </div>
