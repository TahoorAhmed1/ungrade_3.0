...
import { addOutcomes, updateOutcomes } from "@/module/features/outcomesSlice";
import { useEffect } from "react";


const formSchema = z.object({
  name: z.string().min(1, "outcome is required"),


});

export function OutcomesDialog({ isOpen, type, setOpen, editData }: any) {
